...
int AstranEditorUI::StartupModule()
{
	...
	RobotoMedium = io.Fonts->AddFontFromFileTTF("../Dependency/Imgui/misc/fonts/Roboto-Medium.ttf", 20.0f);
	...
	DroidSans = io.Fonts->AddFontFromFileTTF("../Dependency/Imgui/misc/fonts/DroidSans.ttf", 18.0f, &config);
...
void AstranEditorUI::IconLoad()
{
	...
	appIcon = new Texture("../Icons/UE4.png", Texture::TextureSourceType::RASTER, 1, false);
	GameObjectOn = new Texture("../Icons/GameObject On@64.png", Texture::TextureSourceType::RASTER, 1, false);
	TransformIcon = new Texture("../Icons/d_Transform@32.png", Texture::TextureSourceType::RASTER, 1, false);
	ThreeDotButtonIcon = new Texture("../Icons/_Menu@2x.png", Texture::TextureSourceType::RASTER, 1, false);
...
void AstranEditorUI::Editor()
{
	...
	if (ImGuiCleanUp cp(ImGui::Begin("AstranEditor", nullptr, window_flags), ImGui::End, true); cp.opened)
	{
		...
		ImGui::BeginGroup();
		{
			...
			ImGui::BeginGroup();
			{
				...
				//Minimize, Maximize, Close Button
				{
					...
					ImGui::SameLine();
					ImGui::WindowButton(minimize_button_id, 0);

					ImGui::SameLine();
					ImGui::WindowButton(maximize_button_id, 1);

					ImGui::SameLine();
					ImGui::WindowButton(close_button_id, 2);
